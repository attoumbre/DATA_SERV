        ...
        <article>
            ...
            <div class="col-10 col-md-12 ">
                ...
                <div class="single-blog-content ">
                    ...
                    <p>Relativement à l’optimisation de ses activités, Digital Universe dispose de plusieurs technologies de développement de logiciels dont des AGL (Atelier de Génie Logiciel) qui permettent un gain de temps dans nos processus de réalisation qui implique des coûts sensibles pour nos clients. Aussi, c'est ateliers permettent 
                        d’éditer et de commercialiser plusieurs logiciels dans le domaine de la gestion d'entreprise, l'administration des ventes, 
                        la logistique, la comptabilité, le e-commerce, et d'une façon générale, tous les postes de gestion d'une
                        activité de production ou de négoce. De plus, elle propose aussi des solutions dans la sécurisation des systèmes 
                        informatique, dans l’étude préventive des données de production et bénéfice ainsi que dans l’implémentation des systèmes
                        embarqués, apportant ainsi un apport prestigieux aux entreprises désireuses d’atomiser plusieurs tâches au sein de leurs unités de production.
                    </p>
                    <p>
                        A cet effet, grâce à plusieurs années d'expériences dans ces différents métiers, nos chargés de projets possèdent le recul et les
                         méthodes de travail essentielles pour répondre aux attentes de votre organisation. Digital Universe c'est aussi un service 
                         support 
                         (hotline, assistance, maintenance) dédié à nos clients, disposant de 2 niveaux de traitements, et assurant une prise en 
                         charge rapide et
                        tracée grâce à une organisation interne spécifique et informatisée en conséquence.
                    </p>
                    <h4>Notre but:</h4>
                    <p>Vous accompagnez pas à pas dans
                        l’élaboration de vos projets jusqu’à leurs réalisations.
                    </p>
